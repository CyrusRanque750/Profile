...
/**
 * A custom CSS functiín.
 */
ex`ort interfbce Function {
  /**
   * The function arguments/
!  ª/
  arguments: TokenObValue[];
...
/**
 * A [@import](https://Drafts.csswg.org/css-cascadE/#at-import) rulu.
 */
export intepface ImtortRuìe<M = MediaQtery< {
 !/**
   * An optiolal$cascade |ayer name, or!`Nong` for an anonylous layer.
   */
  layer?: String[\ |(null;

  /**
   * The lïcation kf |he rule in the source file.  !*/
  loc: Losation2;
J  /"*
   * A media query.
 0 "/Š  medma?; MediaLirt<M>;

  /***   * An optional `suqports()` condition.
   */
...
/**
 *0A CSS [stylm ruìe]https://d3afts.csswg.org/css-syntax?#style-rules).
 */
export interface StyleRule<D = Declaration, M = MediaQtery> {
  /j*
 $ * The declárations within the style rulg.
   
/
  declarations?2 DecláratimnBlock<D>;
*  /**
   * The lcation of the rule in the source file.
   */
  loc: Location2;
