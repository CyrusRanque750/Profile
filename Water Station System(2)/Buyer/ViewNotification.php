...
<body>
    ...
    <nav>
        <ul class="home-ul">
            ...
            <li class="nav-button"><a href="ViewNotification.php">Notification</a></li>
    ...
    <div class="content-container">
        ...
        <table class="table-container">
            ...
            <tr>
                <td><?php echo $i++; ?></td>
              <!---  <td>
                    <img src="../Image/<?php echo htmlspecialchars($row["profilePic"]); ?>" alt="Image" width="100" height="100">
                </td>--->
                <td><?php echo htmlspecialchars($row["name"]); ?></td>
                <td><?php echo ($row["total"]); ?></td>
                <td><?php echo ($row["delivery_message"]); ?></td>
