...
<body>
    ...
    <div id="myModal" class="modal">
        ...
        <a href="FrontPage.php"><span class="close-button">&times;</span></a>
            <h2>Are you a User or a Buyer?</h2>
            <button id="userButton"><a href="Seller-Registration.php">Seller</a></button>
            <button id="buyerButton"><a href="Buyer-Registration.php">Buyer</a></button>
            <!--<button id="adminButton"><a href="Admin-Registration.php">Admin</a></button>-->
        </div>
    </div>
</body>
</html>