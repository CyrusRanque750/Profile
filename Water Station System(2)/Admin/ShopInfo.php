...
if (isset($_POST['delete'])) {
    $id = intval($_POST['id']);
    $deleteQuery = "DELETE FROM shopinfo WHERE id = $id";
...
if (isset($_POST['edit'])) {
    $id = intval($_POST['id']);
    header("Location: EditShop.php?id=$id");
    exit(); 
}
...
if (isset($_POST['view'])) {
    $id = intval($_POST['id']);
    header("Location: ViewShop.php?id=$id"); 
    exit(); 
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="content-container">
        ...
        <table>
            ...
            <?php
            $i = 1;
            $rows = mysqli_query($conn, "SELECT * FROM shopinfo ORDER BY id DESC");
            ...
            <tr>
                <td><?php echo $i++; ?></td>
                <td>
                    <img src="../Image/<?php echo htmlspecialchars($row["profilePic"]); ?>" width="100" height="100">
                </td>
                <td>
                    <img src="../Image/<?php echo htmlspecialchars($row["permit"]); ?>" width="100" height="100">
                </td>
